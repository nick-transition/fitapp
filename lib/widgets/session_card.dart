...
class SessionCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Card(
      ...
      // The InkWell's tap doesn't surface in the merged card semantics, which
      // leaves assistive tech (and e2e tests) unable to open the detail
      // screen. Expose it explicitly as a button.
      child: Semantics(
        button: true,
        onTap: openDetail,
        child: InkWell(
